...
(function() {
  var DB, Dispatcher, Feeling, Session, User, WaitItem, app, auto_feeling, clone, concat, express, gDB, gDispatcher, len, max, merge_feelings, min, now, rand, remove_item, require_auth, schedule, u0, u1, u2, valid_session;
  ...
  User = (function() {
    ...
    User.prototype.valid_arrived_feeling = function(id) {
      console.log(this.arrived_feelings.length);
      console.log("valid: " + id);
      console.log(typeof this.arrived_feelings[0]);
    ...
    User.prototype.grab_feeling = function(fid) {
      return this.rcv_feelings.unshift(fid);
    };
  ...
  Dispatcher = (function() {
    ...
    Dispatcher.prototype.run = function() {
      var fid, hungry_users, u, wu, _results;
      hungry_users = [];
    ...
    Dispatcher.prototype.register_user = function(uid) {
      return this.user_que.push(new WaitItem(uid));
    };
