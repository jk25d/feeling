...
(function() {
  var DB, Dispatcher, Feeling, OrderedMap, OrderedSet, ReverdSet, Session, User, UserFeelings, WaitItem, app, auto_feeling, clone, concat, express, gDB, gDispatcher, gFeelingContainer, len, max, merge_feelings, min, now, rand, remove_item, require_auth, schedule, u0, u1, u2, valid_session, _ref, _ref1,
  ...
  auto_feeling = function(user) {
    var a, word, _i, _ref2, _results;
    word = rand(0, 29);
    a = [];
    (function() {
      _results = [];
      for (var _i = 0, _ref2 = rand(0, 9); 0 <= _ref2 ? _i <= _ref2 : _i >= _ref2; 0 <= _ref2 ? _i++ : _i--){ _results.push(_i); }
      return _results;
    }).apply(this).forEach(function() {
      return a.push('blah ');
    });
